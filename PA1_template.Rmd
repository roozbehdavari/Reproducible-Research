...
For imputed missing value dataset, the mean of total number of steps taken per day is `r mean.steps` while the median is `r median.steps`. Note that both mean has changed for only few percents. This was expected as we imputed the missing values based on random replacement of existing values. 
